...
logreg_model_no_scaling = LogisticRegression(max_iter=10000)
logreg_model_no_scaling.fit(X_train, y_train)


y_pred_no_scaling = logreg_model_no_scaling.predict(X_test)
...
plot_confusion_matrix(conf_matrix_no_scaling, title="Confusion Matrix (Ölçeklendirilmemiş Veri)")
plot_confusion_matrix(conf_matrix_scaled, title="Confusion Matrix (Ölçeklendirilmiş Veri)")

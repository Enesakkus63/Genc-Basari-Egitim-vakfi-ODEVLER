...
plot_confusion_matrix(conf_matrix_no_scaling, title="Confusion Matrix (KNN - Ölçeklendirilmemiş Veri)")
plot_confusion_matrix(conf_matrix_scaled, title="Confusion Matrix (KNN - Ölçeklendirilmiş Veri)")

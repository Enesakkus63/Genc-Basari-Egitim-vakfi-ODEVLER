...
nb_model_no_scaling = GaussianNB()
nb_model_no_scaling.fit(X_train, y_train)

y_pred_no_scaling = nb_model_no_scaling.predict(X_test)
...
y_pred_scaled = nb_model_scaled.predict(X_test_scaled)
...
plot_confusion_matrix(conf_matrix_no_scaling, title="Confusion Matrix (Naive Bayes - Ölçeklendirilmemiş Veri)")
plot_confusion_matrix(conf_matrix_scaled, title="Confusion Matrix (Naive Bayes - Ölçeklendirilmiş Veri)")
